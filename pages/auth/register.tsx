...
export default function NewEntryPage() {
  return (
      ...
      <div className="grid justify-center items-center bg-white h-screen">
		<form className="place-self-center" action="register.php" method="post">
			<h1 className="text-gray-800 font-bold text-5xl mb-2">Register</h1>
				<div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
					...
					<div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
						...
						<div className="flex items-center border-2 py-2 px-3 rounded-2xl">
							...
							<button type="submit" className="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-bold mb-2">Register</button>
							<div className="grid">
							<span className="text-sm ml-2 hover:text-blue-500 cursor-pointer">Forgot Password ?</span>
							<span className="text-sm ml-2">Already registered? <a href="/" className="text-blue-700 hover:underline dark:text-blue-500">Login</a></span>
							</div>
		</form>
	</div>
    </>
